...
import com.in28minutes.webservices.restfulwebservices.todo.Todo;
...
public class TodoResource {
	...
	public ResponseEntity<Todo> updateTodo(@RequestBody Todo todo) {
		Todo createdTodo = todoService.update(todo);
		return new ResponseEntity<Todo>(todo, HttpStatus.OK);
	}

	// Edit/Update a Todo_Data
	// PUT /users/{user_name}/todos_id}
